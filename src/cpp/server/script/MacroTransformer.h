...
public:
    ...
    virtual bool matches (
        ScriptObjectPointer form, Scope* scope, ScriptObjectPointerVector& variables) const = 0;
};
...
public:
     ...
     */
    virtual ScriptObjectPointer generate (ScriptObjectPointerVector& variables) const = 0;
};
...
public:
     ...
     * Generates the contents of the template.
     */
    virtual ScriptObjectPointer generate (ScriptObjectPointerVector& variables) const;
...
/**
 * A simple interface that allows building a list or vector element-by-element.
 */
class ObjectBuilder
{
public:
    ...
    /**
     * Appends the provided element.
     */
    virtual void append (const ScriptObjectPointer& element) = 0;
};

/**
 * Builds a list.
 */
class ListBuilder : public ObjectBuilder
{
public:
     ...
     */
    ScriptObjectPointer list (const ScriptObjectPointer& rest);

    /**
     * Appends the provided element.
     */
    virtual void append (const ScriptObjectPointer& element);

protected:

    /** The current head and tail of the list. */
    ScriptObjectPointer _head, _tail;
};

/**
 * Builds a vector
 */
class VectorBuilder : public ObjectBuilder
{
public:

    /**
     * Returns a reference to the constructed vector.
     */
    const ScriptObjectPointerVector& vector () const { return _vector; }
...
protected:
    ...
    /** The vector to which we append. */
    ScriptObjectPointerVector _vector;
};

/**
 * A subtemplate within a list or vector template.
 */
class Subtemplate
{
public:
     ...
     */
    void generate (ScriptObjectPointerVector& variables, ObjectBuilder* builder) const;
...
protected:
     ...
     * Generates the contents of the template.
     */
    void generate (ScriptObjectPointerVector& variables,
        ObjectBuilder* builder, int depth) const;
...
public:
     ...
     */
    VectorTemplate (const QVector<Subtemplate>& subtemplates);
